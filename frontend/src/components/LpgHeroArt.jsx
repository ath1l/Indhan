...
const LpgHeroArt = () => {
  return (
    <div className="w-full h-64 md:h-80 bg-white border border-slate-200 rounded-[32px] overflow-hidden relative shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-10 group">
      ...
      {/* --- TEXT CONTENT --- */}
      <div className="absolute top-8 left-10 md:top-10 md:left-12 z-20 pointer-events-none">
        <h2 className="text-[10px] font-bold tracking-[0.2em] text-slate-400 uppercase mb-3 flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
          INDHAN Energy Intelligence
        </h2>
        <h1 className="text-3xl md:text-5xl font-display font-bold text-slate-900 tracking-tight mb-3">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-end justify-end">
        <svg 
          ...
          className="w-full h-full min-w-[800px] text-slate-900"
        >
          <defs>
